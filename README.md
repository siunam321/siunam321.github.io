...
- CTF Writeups
	...
	- PortSwigger Labs
		- Cross-Site Scripting
			- [DOM XSS in `document.write` sink using source `location.search` inside a select element](https://siunam321.github.io/ctf/portswigger-labs/Cross-Site-Scripting/xss-10), Dec 29, 2022
